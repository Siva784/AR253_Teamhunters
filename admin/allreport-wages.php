                ...
                <div class="row">
                    <div class="col-lg">
                        <section class="card">
                            ...
                            <div class="card-body">
                                <form action="allreport-wages.php" method="post">
                                    <div class="form-row">
                                        <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-lg">
                        ...
                        if (isset($_POST['sdate'])) {
                            $sdate = $_POST['sdate'];
                            $edate = $_POST['edate'];
                        $wages = "SELECT w.date,m.name,m.phnum,m.type,m.joining_date,w.amt,m.mill_id FROM `worker_wages` w,mill_workers m WHERE date BETWEEN '$sdate' AND '$edate' && m.mill_id = w.mill_id && m.worker_id = w.worker_id";
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php 
                                                            $millnamequery="SELECT  `mill_name` FROM `mills` WHERE mill_id={$wage['mill_id']}";
                                                            $resmillname=mysqli_query($conn,$millnamequery);
                                                            $rowname=mysqli_fetch_assoc($resmillname);
                                                            echo $rowname['mill_name'];
