...
if (isset($_POST['phnum']) && isset($_POST['passwd'])) {
	...
	if ($_POST['phnum'] == $login_row['far_phnum'] && $_POST['passwd'] == $login_row['far_passwd']) {
		session_start();
		$_SESSION['far_id'] = $login_row['far_id'];
				...
				<div class="row">
					<div class="col-md-5 col-md-push-1 animate-box">
						...
						<div class="colorlib-contact-info">
							...
							Don't Have a Account<a href='farmer-signup.php'> REGISTER HERE. </a>
