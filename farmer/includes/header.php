	        ...
	        <div id="userbox" class="userbox">
	            <a href="#" data-toggle="dropdown">
	                <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
	                    <span class="name">
						<?php
						// echo $fac['fac_name']; ?></span>
						<span class="role"><?php
						// echo $fac['fac_designation']; ?></span>
	                </div>
	            ...
	            <div class="dropdown-menu">
	                <ul class="list-unstyled mb-2">
	                    <li class="divider"></li>
	                    <li>
							<a role="menuitem" tabindex="-1" href="../fac_details.php?fac_id=<?php
							// echo $_SESSION['fac_id']; ?>" target='_blank'><i class="fas fa-user"></i> My Profile</a>
	                    </li>
	                    <li>
							<a role="menuitem" tabindex="-1" href="<?php 
							//echo $_SERVER['PHP_SELF'] . "?lo"; ?>"><i class="fas fa-power-off"></i> Logout</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
